...
- `virtio-win-1.9.45.iso` from [Red Hat Enterprise Linux 10 — AppStream](https://github.com/ItzLevvie/artifacts/releases/download/20250409.1/virtio-win-1.9.45.iso) is mounted as a DVD Drive on Hyper-V.
